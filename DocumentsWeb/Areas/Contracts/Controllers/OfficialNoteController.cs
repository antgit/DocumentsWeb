...
namespace DocumentsWeb.Areas.Contracts.Controllers
{
    ...
    public class OfficialNoteController : DocumentsWeb.Controllers.ContractController
    {
        public OfficialNoteController()
        {
            Name = "WEBДСЛУЖЗАП";
        ...
        public override ActionResult Edit([ModelBinder(typeof(DevExpressEditorsBinder))] DocumentContractModel model)
        {
            ...
            model.Notes = m.Notes;
            model.MemoAdv = HtmlEditorExtension.GetHtml("MemoAdv");
            if (ModelState.IsValid)
            {
                ...
                if (doc.Document.AgentDepartmentFrom != null)
                ...
                model.Details = doc.Details.Select(DocumentDetailContractModel.ConvertToModel).ToList();
        ...
        public ActionResult MemoFullPartial(string modelId)
        {
            DocumentContractModel model = (DocumentContractModel)WADataProvider.ModelsCache.Get(modelId);
            model.MemoAdv = HtmlEditorExtension.GetHtml("MemoAdv");
            return View(model);
        }

        public ActionResult SenderIdPartial()
        {
        ...
        public ActionResult RecipientIdPartial()
        {
            int mainCompanyDepatmentId = int.Parse(Request.Params["MainCompanyDepatmentId"] == null || Request.Params["MainCompanyDepatmentId"] == "null" ? "0" : Request.Params["MainCompanyDepatmentId"]);
            int id = int.Parse(Request.Params["Id"]);
