...
{
    /// <summary>
    /// Контроллер настройки раздела "Налоговые"
    /// </summary>
    [Authorize(Roles = Uid.GROUP_GROUPWEBADMIN)]
    public class DocumentConfigTaxController : BaseDocumentConfigController
    {
        public DocumentConfigTaxController()
        {
            Name = "WEBНННАСТРОЙКА";
            FolderCodeFind = Folder.CODE_FIND_TAX_CONFIG;
        }
        ...
        public virtual ActionResult Create(int? tmlId = null)
        {
            ...
            DocumentConfigTaxesModel documentSaleModel = new DocumentConfigTaxesModel { FormCode = formCode };
        ...
        public virtual ActionResult Edit(int id)
        {
            ...
            DocumentConfigTaxesModel model = DocumentConfigTaxesModel.GetObject(id);
        ...
        {
            DocumentConfigTaxesModel documentModel = (DocumentConfigTaxesModel)WADataProvider.ModelsCache.Get(modelId);
        ...
        [HttpPost]
        public virtual ActionResult Edit([ModelBinder(typeof(DevExpressEditorsBinder))] DocumentConfigTaxesModel model)
        {
            DocumentConfigTaxesModel documentSaleModel = (DocumentConfigTaxesModel)WADataProvider.ModelsCache.Get(model.ModelId);
        ...
        {
            DocumentConfigTaxesModel.CreateCopy(id);
        }
