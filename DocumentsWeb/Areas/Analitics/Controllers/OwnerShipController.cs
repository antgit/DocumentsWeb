...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class OwnerShipController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_AGENTOWNERSHIP;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_OWNERSHIP;

        public OwnerShipController()
        {
            Name = WebModuleNames.WEB_OWNERSHIP;
