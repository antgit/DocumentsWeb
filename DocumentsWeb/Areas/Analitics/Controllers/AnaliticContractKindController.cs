...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticContractKindController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_CONTRACT_KIND;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_CONTRACTTYPE;

        public AnaliticContractKindController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICCONTRACTKIND;
