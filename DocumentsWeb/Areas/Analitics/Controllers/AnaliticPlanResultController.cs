...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticPlanResultController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_FINPLANRESULT;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_FINPLANRESULT;

        public AnaliticPlanResultController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICFINPLANRESULT;
