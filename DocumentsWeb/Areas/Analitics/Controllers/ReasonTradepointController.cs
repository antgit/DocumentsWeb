...
{
    /// <summary>
    /// Состояние отношений с торговой точкой
    /// </summary>
    [MultiAuthorize(Roles = new[] { Uid.GROUP_GROUPWEBUSER })]
    public class ReasonTradepointController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_REASONTRADEPOINT;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_REASONTRADEPOINT;

        public ReasonTradepointController()
        {
            Name = WebModuleNames.WEB_REASONTRADEPOINT;
