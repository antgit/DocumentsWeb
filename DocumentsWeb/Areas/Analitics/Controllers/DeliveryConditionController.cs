...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class DeliveryConditionController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_DELIVERYCONDITION;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_DELIVERY;

        public DeliveryConditionController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICDELIVERY;
