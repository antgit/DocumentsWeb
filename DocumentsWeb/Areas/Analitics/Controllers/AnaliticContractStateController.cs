...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticContractStateController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_CONTRACT_STATE;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_CONTRACTSTATE;

        public AnaliticContractStateController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICCONTRACTSTATE;
