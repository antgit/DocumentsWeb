...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class ProductTypeController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_PRODUCTTYPE;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_PRODUCTTYPE;

        public ProductTypeController()
        {
            Name = WebModuleNames.WEB_PRODUCTTYPE;
