...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticPlanKindController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_FINPLANKIND;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_FINPLANKIND;

        public AnaliticPlanKindController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICFINPLANKIND;
