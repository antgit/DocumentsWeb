...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class ProductPackTypeController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_PACKTYPE;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_PACKAGINGTYPE;

        public ProductPackTypeController()
        {
            Name = WebModuleNames.WEB_PACK;
