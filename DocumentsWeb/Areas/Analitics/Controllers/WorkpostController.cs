...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class WorkpostController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_WORKPOST;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_POST;

        public WorkpostController()
        {
            Name = WebModuleNames.WEB_WORKPOST;
