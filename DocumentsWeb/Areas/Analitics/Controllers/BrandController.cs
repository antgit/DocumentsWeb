...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class BrandController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_BRANDS;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_BRAND;

        public BrandController()
        {
            Name = WebModuleNames.WEB_BREND;
