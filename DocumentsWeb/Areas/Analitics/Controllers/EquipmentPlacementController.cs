...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class EquipmentPlacementController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_EQUIPMENTPLACEMENT;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_EQUIPMENTPLACEMENT;

        public EquipmentPlacementController()
        {
            Name = WebModuleNames.WEB_EQUIPMENTPLACEMENT;
