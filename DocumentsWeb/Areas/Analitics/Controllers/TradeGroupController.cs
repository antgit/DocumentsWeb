...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class TradeGroupController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_TRADEGROUP;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_TRADEGROUP;

        public TradeGroupController()
        {
            Name = WebModuleNames.WEB_PRODUCTGROUP;
