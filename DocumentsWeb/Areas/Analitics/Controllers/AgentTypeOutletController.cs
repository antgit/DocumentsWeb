...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AgentTypeOutletController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_AGENTTYPEOUTLET;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_OUTLETTYPE;

        public AgentTypeOutletController()
        {
            Name = WebModuleNames.WEB_OUTLETTYPE;
