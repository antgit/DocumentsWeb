...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class ReturnReasonController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_RETURNREASON;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_RETURNREASON;

        public ReturnReasonController()
        {
            Name = WebModuleNames.WEB_RETURN;
