...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticCfoController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITICCFO;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_CFO;

        public AnaliticCfoController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICCFO;
