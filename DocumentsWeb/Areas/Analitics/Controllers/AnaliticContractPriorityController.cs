...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class AnaliticContractPriorityController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_CONTRACTPRIORITY;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_IMPORTANCE;

        public AnaliticContractPriorityController()
        {
            Name = WebModuleNames.WEB_MODULE_DICTIONARY_ANALITICCONTRACTPRIORITY;
