...
{
    /// <summary>
    /// Категория торговой точки (Канал сбыта)
    /// </summary>
    [MultiAuthorize(Roles = new[] { Uid.GROUP_GROUPWEBUSER })]
    public class AgentCategoryController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_AGENTCATEGORY;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_OUTLETCATEGORY;

        public AgentCategoryController()
        {
            Name = WebModuleNames.WEB_AGENTCATEGORY;
