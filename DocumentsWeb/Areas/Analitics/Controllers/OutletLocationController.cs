...
namespace DocumentsWeb.Areas.Analitics.Controllers
{
    ...
    public class OutletLocationController : AnaliticBaseController
    {
        /// <summary>
        /// Корневая иерархия
        /// </summary>
        private const string RootHie = Hierarchy.SYSTEM_ANALITIC_OUTLETLOCATION;

        /// <summary>
        /// Тип аналитики
        /// </summary>
        private const int AnaliticKindId = Analitic.KINDID_OUTLETLOCATION;

        public OutletLocationController()
        {
            Name = WebModuleNames.WEB_OUTLETLOCATION;
