...
namespace DocumentsWeb.Areas.ServicesNds.Controllers
{
    ...
    public class ViewListAccountInNdsController : CoreDocumentListControler
    {
        public ViewListAccountInNdsController()
        {
            Name = "WEBУСФВNDS";
        ...
        {
            return PartialView(ServicesHelper.GetDocumentsAccounts(true, FolderCodeFind, true));
        }
