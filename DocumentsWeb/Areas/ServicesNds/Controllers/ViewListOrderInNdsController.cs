...
namespace DocumentsWeb.Areas.ServicesNds.Controllers
{
    ...
    public class ViewListOrderInNdsController : CoreDocumentListControler
    {
        ...
        {
            return PartialView(ServicesHelper.GetDocumentsOrders(true, FolderCodeFind, true));
        }
        ...
        public ActionResult ToTrash(int id)
        {
            ...
            return PartialView("IndexPartial", ServicesHelper.GetDocumentsOrders(true, FolderCodeFind, true));
        }
