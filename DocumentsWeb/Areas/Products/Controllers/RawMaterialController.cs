...
{
    /// <summary>
    /// Контроллер объектов "Сырье"
    /// </summary>
    [MultiAuthorize(Roles = new[] { Uid.GROUP_GROUPWEBUSER })]
    public class RawMaterialController : CoreController<Product>
    {
        public RawMaterialController()
        {
            Name = WebModuleNames.WEB_RAWMATERIALS;
            RootHierachy = Hierarchy.SYSTEM_PRODUCT_RAWMATERIALS;
        }
        ...
        {
            ProductModel model = new ProductModel { Id = 0, Name = string.Empty, KindId = Product.KINDID_RAWMATERIAL };
            WADataProvider.ModelsCache.Add(model.ModelId, model);
        ...
        public ActionResult ExportTo(string type)
        {
            GridViewSettings settings = new GridViewSettings
                {Name = "Товары", CallbackRouteValues = new {Action = "Index", Controller = "RawMaterial"}};
            ...
            IEnumerable coll = ProductModel.GetCollection(Hierarchy.SYSTEM_PRODUCT_RAWMATERIALS);
