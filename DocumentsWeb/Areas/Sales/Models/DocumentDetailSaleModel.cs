...
{
    public class DocumentDetailSaleModel:DocumentDetailBaseModel
    {
        ...
        public DocumentDetailSale ToObject(Workarea workarea, DocumentSales owner)
        {
            DocumentDetailSale detailSale = new DocumentDetailSale
                                                {
        ...
        public static DocumentDetailSaleModel ConvertToModel(DocumentDetailSale value)
        {
            DocumentDetailSaleModel obj = new DocumentDetailSaleModel
                                              {
                                                  Id = value.Id,
                                                  Guid=value.Guid,
