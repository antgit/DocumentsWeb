...
{
    public class DocumentDetailFinanceModel: DocumentDetailBaseModel
    {
        ...
        public DocumentDetailFinance ToObject(Workarea workarea, DocumentFinance owner)
        {
            DocumentDetailFinance detailFinance = new DocumentDetailFinance
            {
        ...
        public static DocumentDetailFinanceModel ConvertToModel(DocumentDetailFinance value)
        {
            DocumentDetailFinanceModel obj = new DocumentDetailFinanceModel
            {
                Id = value.Id,
                Guid=value.Guid,
