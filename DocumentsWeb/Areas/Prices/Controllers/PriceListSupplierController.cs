...
namespace DocumentsWeb.Areas.Prices.Controllers
{
    ...
    public class PriceListSupplierController : DocumentsWeb.Controllers.PriceListController
    {
        public PriceListSupplierController()
        {
            Name = "WEBЦПРП";
            FolderCodeFind = Folder.CODE_FIND_PRICES_SYPPLYER;
            DocumentKindId = DocumentPrices.KINDID_SYPPLYER;
        }
